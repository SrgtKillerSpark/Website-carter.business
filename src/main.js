    ...
    <div class="card-content">
      <div class="profile-section">
        <div class="profile-image">
          <img src="/profile.jpg" alt="Photo of Andrew" onerror="this.style.display='none'; this.parentElement.classList.add('no-image');" />
        </div>
      ...
      <footer class="card-footer">
        <a href="/resume.pdf" class="footer-link">
        ...
        <a href="mailto:contact@carter.business" class="footer-link">
